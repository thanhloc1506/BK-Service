  ...
  return (
    <div className="mt-2 p-2 w-40 bg-white rounded-lg border-2 border-gray-200">
      <div className="flex justify-center">
        <select
          name="hours"
          className="bg-transparent text-xl appearance-none outline-none text-right"
          onChange={(e: any) => {
        ...
        >
          ...
          <option value="2" selected={hour === "2"}>
            2
          </option>
          <option value="3" selected={hour === "3"}>
            3
          </option>
          <option value="4" selected={hour === "4"}>
            4
          </option>
          <option value="5" selected={hour === "5"}>
            5
          </option>
          <option value="6" selected={hour === "6"}>
            6
          </option>
          <option value="7" selected={hour === "7"}>
            7
          </option>
          <option value="8" selected={hour === "8"}>
            8
          </option>
          <option value="9" selected={hour === "9"}>
            9
          </option>
        ...
        >
          <option value="am" selected={ap === "am"}>
            AM
          </option>
          <option value="pm" selected={ap === "pm"}>
            PM
          </option>
        </select>
      </div>
