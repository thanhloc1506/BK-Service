...
import {hideResult, search, setCurrentSearchText, showResult} from "../../redux/slices/search";
...
export const SearchField = () => {
    ...
    return <div>
        <div className={'px-4 py-4 bg-gray-100 my-5 flex w-full justify-center items-center rounded z-10 relative'}
             style={{zIndex: 10}}>
            <div className={'px-4'}>
                <BsSearch/>
            </div>
