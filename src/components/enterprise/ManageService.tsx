...
const DialogConfirmAvatar = ({show, setShow, onCancel, onConfirm}: DialogConfirmAvatarProp) => (
...
const Profile = () => {
    const state: Enterprise | undefined = useSelector((state: RootState) => state.user.enterprise);
    ...
    return (
        <div className={'flex justify-center'}>
            <div
                className={'flex flex-col justify-center gap-2 p-6 min-w-[50%] bg-white rounded-lg border border-gray-200 shadow-md transition-all duration-300'}>
                <div className={'flex justify-between gap-32'}>
                    <p className={'mb-2 text-2xl font-bold tracking-tight text-gray-900'}>Thông tin doanh nghiệp</p>
                    <p>
                ...
                <div className={'flex flex-col gap-2'}>
                    ...
                    <div className="">
                        <label className="block mb-2 text-sm font-medium text-gray-900">Tên doanh nghiệp</label>
                        <input
                            disabled={!enableEdit}
                            type="text"
                            className="input"
                    ...
                    <div className="">
                        <label className="block mb-2 text-sm font-medium text-gray-900">Số điện thọai</label>
                        <input
                            disabled={!enableEdit}
                            type="text"
                            className="input"
                    ...
                    <div className={'mt-5'} hidden={!enableEdit}>
                        <button
                            ...
                            className={'w-full m-auto text-green-500  bg-green-100 hover:bg-green-200 focus:ring-4 focus:outline-none focus:ring-green-100 font-medium rounded-lg text-center py-3'}
                        >
...
const ManageService = () => {
    ...
    useEffect(() => {
        dispatch(showWaiting());
        axiosClient.get<PInOverview>('enterprise/get-overview-analysis')
    ...
    return (
        <div>
            ...
            <div>
                <div className={'flex justify-center mt-3 gap-10'}>
                    <div
                        ...
                        <div>
                            <p className={'text-2xl font-bold tracking-tight text-gray-900'}>{overView?.numOfService || 0}</p>
                        </div>
                        <div>
            ...
            <div className={'block flex flex-col justify-center items-center gap-2 p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md hover:shadow-xl transition-all duration-300'}>
                ...
                <div>
                    <p className={'text-2xl font-bold tracking-tight text-gray-900'}>{overView?.numOfDoneSchedule || 0}</p>
                </div>
                <div>
