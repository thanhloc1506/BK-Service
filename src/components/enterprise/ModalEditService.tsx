...
const submitChangeService = (
  ...
  if (removeImg && removeImg.length > 0)
    formData.append("removeImg", JSON.stringify(removeImg));
      ...
      <Transition appear show={show} as={Fragment}>
        ...
        >
          <div className="min-h-screen px-16 text-center">
            ...
            >
              <div className=" relative inline-block w-1/2 h-[90vh] p-8 my-8 overflow-auto text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                <Dialog.Title
                  as="h3"
                ...
                <div className="mt-2">
                  ...
                  />
                  <ModalIntroduction
                    show={showModalShortIntro}
                    setShow={setShowModalShortIntro}
                    onSave={(v) => {
                      setEditData((e) => {
                  ...
                  <div className={"flex flex-col gap-3"}>
                          ...
                          editData &&
                            setEditData((pre) => {
                              if (pre)
                                return {
                                  ...pre,
                                  scheduleAllowedPerHour: parseInt(
                                    e.target.value
                                  ),
                                };
                            });
                    ...
                    <div className="">
                      ...
                      <div className={"w-full"}>
                        <div
                          className={
                            "my-10 flex flex-wrap justify-center gap-2"
                          }
                        >
                          {oldImg &&
                            oldImg.map((data, index) => (
                              <ImageControl
                                key={index}
                                url={data.url}
                                onDelete={() => {
                                  setOldImg((pre) => {
                                    if (pre)
                                      return pre.filter((v) => v != data);
                                  });
                                }}
                              />
                            ))}
                          {newImg &&
                            newImg.map((data, index) => {
                              return (
                                <ImageControl
                    ...
                    <div className={"flex justify-center"}>
                      <button
                        className={
                          "text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-16 py-2.5"
                        }
                        onClick={() => {
                          setShow && setShow(false);
                          dispatch(showWaiting());
