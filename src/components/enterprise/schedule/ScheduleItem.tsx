    ...
    <div className="2xl:mb-5 xl:mb-4 lg:mb-3">
      ...
      >
        ...
        >
          <img
            src={
              data.user?.avatar?.url ? data.user?.avatar?.url : DEFAULT_AVATAR
            }
            alt=""
        ...
        <div>
          <div className={"flex flex-col justify-center h-full gap-8"}>
            <button
              className={
                "2xl:w-3/4 xl:w-5/6 lg:w-full text-green-500 bg-green-100 hover:bg-green-200 focus:ring-4 focus:outline-none focus:ring-green-100 font-medium rounded-lg  text-center 2xl:py-3 xl:py-2 lg:py-1 xl:ml-5"
              }
              onClick={() => setShowModalDone(true)}
            >
              <BsCheckLg
                className={"inline mr-2 2xl:text-xl xl:text-lg lg:text-lg"}
              />
              <p className={"inline 2xl:text-lg xl:text-sm lg:text-xs"}>
                Hoàn thành
              </p>
