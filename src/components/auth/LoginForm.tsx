  ...
  return (
    <Transition.Root show={authState.showLoginForm} as={Fragment}>
      <Dialog
        ...
        onClose={toggleForm}
      >
        <div className="flex 2xl:mt-16 xl:mt-10 lg:mt-10 justify-center text-center">
          <Transition.Child
            as={Fragment}
          ...
          >
            <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all 2xl:w-1100 2xl:h-650 xl:h-[85vh] xl:w-[80vw] lg:h-[416px] lg:w-[820px]">
                      ...
                      <div className="col-span-2 bg-white rounded-l-5xl">
                        <div className="2xl:mt-40 xl:mt-16 lg:mt-16">
                          ...
                          <div className="flex justify-center 2xl:mt-6 xl:mt-4 lg:mt-3 2xl:ml-20 xl:ml-12 lg:ml-10">
                            ...
                            <p
                              className="inline-block ml-2 text-blue-400 cursor-pointer 2xl:text-lg xl:text-sm lg:text-xs xl:mt-0 lg:mt-1"
                              onClick={navigate}
                            >
                              Đăng ký ngay
                            </p>
