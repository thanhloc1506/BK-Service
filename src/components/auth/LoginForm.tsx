  ...
  return (
    <Transition.Root show={authState.showLoginForm} as={Fragment}>
      <Dialog
        ...
        onClose={toggleForm}
      >
        <div className="flex 2xl:mt-16 xl:mt-10 justify-center text-center">
          <Transition.Child
            as={Fragment}
          ...
          >
            <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all 2xl:w-1100 2xl:h-650 xl:h-[85vh] xl:w-[80vw]">
