    ...
    case NotiType.FOLLOWED:
      return (
        <span className="2xl:text-lg xl:text-sm lg:text-xs">
          ...
          <span className="">đã theo dõi dịch vụ </span>
    ...
    case NotiType.UNFOLLOWED:
      return (
        <span className="2xl:text-lg xl:text-sm lg:text-xs">
          ...
          <span className="">đã hủy theo dõi dịch vụ </span>
          <span className="font-semibold">{noti.service.name} </span>
          của bạn
        </span>
        // <p className="2xl:text-lg xl:text-sm">
        //   <strong className="2xl:text-lg xl:text-sm">
        //     {noti.user.fullName ? noti.user.fullName : noti.user.username}
        //   </strong>{" "}
        //   đã hủy theo dõi dịch vụ{" "}
        //   <strong className="2xl:text-lg xl:text-sm">
        //     {noti.service.name}{" "}
        //   </strong>
        //   của bạn
