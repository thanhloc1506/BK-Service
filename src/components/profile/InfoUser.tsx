...
const InfoUser: React.FC = () => {
    ...
    const onClickModify = () => {
        ...
        axiosClient.put("/user/update-profile", {
            fullName: name,
            birthday: birthday
        })
            ...
            <div className="grid grid-cols-7">
                <div className="col-span-5 border-r-2 border-r-gray-200 h-[78vh] py-5">
                    <div className={"flex justify-center items-center"}>
                        <div
                            className={"relative w-32 h-32 rounded-full overflow-hidden group ring-4 ring-blue-300 p-2"}>
                            <img
                                src={state.user?.avatar ? state.user.avatar : DEFAULT_AVATAR}
                                className={"rounded-full  w-full h-full"}/>
                            <button
                                onClick={onChangeAvatarClick}
                                className={"text-white h-16 transition-all duration-300 absolute bg-black/70 opacity-0 top-[50%] left-0 w-full group-hover:opacity-100"}>
                                Edit
                            </button>
                    ...
                    <div className={'bg-white rounded-lg border border-gray-200 shadow-md w-3/4 m-auto p-4'}>
                        ...
                        <div className="grid grid-cols-4 mt-10">
                            ...
                            <div className="col-span-3">
                                ...
                                <input
                                    type="date"
                                    className="rounded-xl h-10 mt-2 ml-16 w-[50vh] border-2 border-gray-200 outline-none p-5 text-lg"
                                    defaultValue={state.user && state.user.birthday? (new Date(state.user?.birthday)).toISOString().substring(0, 10): undefined}
                                    disabled={!modify}
                                    onChange={(e)=>{
                        ...
                        <div className="grid grid-cols-4 mt-10">
                            ...
                            <div className="col-span-3">
                                <Listbox value={SEX} onChange={(value: any) => setSex(value)} disabled={!modify}>
                                    <div className="relative" >
                                        <Listbox.Button
                                            className="relative w-[50vh] h-10 px-5 mt-2 ml-16 text-left bg-white rounded-xl border-2 border-gray-200 cursor-default focus:outline-none focus-visible:ring-2 focus-visible:ring-opacity-75 focus-visible:ring-white focus-visible:ring-offset-orange-300 focus-visible:ring-offset-2 focus-visible:border-indigo-500 sm:text-sm">
