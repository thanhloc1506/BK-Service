...
export const ScheduleHistoryItem: React.FC<ScheduleHistoryItemProps> = ({data}: ScheduleHistoryItemProps)=>{
                ...
                <div className={'grid grid-cols-2 divide-x gap-2'}>
                    <div className={'flex flex-col gap-2'}>
                        ...
                        <div>
                            ...
                            <p className={'inline'}>{data.date}</p>
                        </div>
                        <div>
                ...
                <div className={'flex flex-col justify-center h-full gap-8'}>
                    {
                        1!==1?(
                            ...
                            <button
                                className={'w-3/4 text-amber-500 bg-yellow-100 hover:bg-amber-200 focus:ring-4 focus:outline-none focus:ring-amber-100 font-medium rounded-lg  text-center py-3'}
                                onClick={()=>navigate(`/detailService/${data.service._id}`)}
                            >
                                <BsFillStarFill className={'inline mr-2'}/>
                                <p className={'inline'}>Đánh giá ngay</p>
                            </button>
                        )
                    }
